...
const cookieImg =
  'https://vignette.wikia.nocookie.net/creepypasta/images/8/81/Panel-cookie-choc-cookie.png/revision/latest?cb=20160111144002';
const foreverAloneImg =
  'http://i3.kym-cdn.com/photos/images/newsfeed/000/150/505/f30fd24c56e1bcfc926883d6a51d5a00.gif';
const questionMarkIcon =
  'https://n6-img-fp.akamaized.net/free-icon/white-question-mark-on-a-black-circular-background_318-35996.jpg?size=338&ext=jpg';
const purposeImg =
  'https://images.lookhuman.com/render/standard/e9kzW1RKcbJOVn5b7gh9eL2KQzpctmZG/greetingcard45-off_white-z1-t-butter-robot.png';
const butterEmote = '<:butter:376775465370779649>';
let count = 0;
let embed;
let lastUser;
...
client.on('message', (message) => {
  ...
  switch (command) {
    case 'butter':
      ...
      break;
    case 'ping':
      message.channel.send('Pinging server...')
        .then((msg) => {
    ...
    case 'about':
      embed = new Discord.RichEmbed()
        .addField(
          `${butterEmote}ButterBot for all your butter needs ${butterEmote}`,
      ...
      setTimeout(function() {
        ...
        .then(() => {
          message.channel.awaitMessages(
              response =>
                response.content === randomWord && response.author == message.author,
              {
                max: 1,
                time: 5000,
                errors: ['time']
    ...
    case 'help':
      ...
      break;
    default:
      message.channel.send('Invalid command. Type ?help for the list of all available commands.');
  }
});
